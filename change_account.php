...
<body >
   ...
   <div class="menu-btn">
    ...
    <main>
    <br><br><br><br>
<form id="form" action="process_request.php" method="POST" enctype="multipart/form-data">
            <div class="change-account">
                <div class="card-change">
                    ...
                    <br>
                        ...
                        <div class="textfield">
                            <label for="motive">Reason for request:</label>
                            <textarea id="motive" name="motive" rows="4" required></textarea>
                        </div>
                        <div class="textfield">
                            <label for="experience">Experience or Background:</label>
                            <textarea id="experience" name="experience" rows="4"></textarea>   
                        </div>
                        <div class="textfield">
                            <label for="portfolio">Portfolio or Examples:</label>
